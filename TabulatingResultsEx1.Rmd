...
```{r ttesting my patients}
#NOTE: binary dep_var...

ttesting <- function(data, dep_var,feat){
  bt <- data}
...
```{r}
#TODO: perform ttest/chisq for exactly one feature, then worry about doing the whole thing all at once =)
